...
private final Logger logger = LoggerFactory.getLogger(this.getClass());
	...
	@AfterReturning("execution(public * com.rollingstone.api.rest.*Controller.createCustomer*(..))")
	...
	@AfterReturning("execution(public * com.rollingstone.api.rest.*Controller.getAllCustomersByPage*(..))")
	...
	@AfterReturning("execution(public * com.rollingstone.api.rest.*Controller.getAllCustomers*(..))")
	...
	@AfterReturning("execution(public * com.rollingstone.api.rest.*Controller.getCustomer*(..))")
	...
	@AfterReturning("execution(public * com.rollingstone.api.rest.*Controller.updateCustomer*(..))")
	...
	@AfterReturning("execution(public * com.rollingstone.api.rest.*Controller.deleteCustomer*(..))")
